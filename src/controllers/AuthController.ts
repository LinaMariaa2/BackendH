...
export class AuthController {
    // Estas propiedades son necesarias para el funcionamiento del código
    ...
    /**
     * Envía un código de verificación por correo electrónico al usuario.
     * @param user La instancia de Persona a la que se le enviará el código.
     */
    ...
    /**
     * Envía un código por correo electrónico para el restablecimiento de contraseña.
     * Este código tiene una expiración de 10 minutos.
     */
    ...
    /**
     * Verifica que el código de restablecimiento de contraseña sea válido y no haya expirado.
     */
        ...
        try {
            ...
            if (!isMatch) {
                ...
                if (user.intentos >= MAX_LOGIN_ATTEMPTS) {
                    ...
                    await user.save();
                    res.status(403).json({ error: `Credenciales inválidas. Demasiados intentos fallidos (${user.intentos}/${MAX_LOGIN_ATTEMPTS}). Tu cuenta ha sido bloqueada. Contacta al administrador si persiste.` });
                    return;
                }
                await user.save();
    ...
    /**
     * Verifica el código que se envió al correo electrónico del usuario durante el registro.
     */
    ...
    /**
     * Reenvía un nuevo código de verificación si el usuario lo solicita.
     */
