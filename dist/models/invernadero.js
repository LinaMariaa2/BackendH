...
__decorate([
    (0, sequelize_typescript_1.BelongsTo)(() => Persona_1.Persona, { foreignKey: 'responsable_id' }),
...
exports.Invernadero = Invernadero = __decorate([
    (0, sequelize_typescript_1.Table)({ tableName: 'tbl_invernadero', timestamps: true })
], Invernadero);
